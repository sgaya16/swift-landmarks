...
struct HexagonParameters {
    struct Segment {  //represents the 3 points that make up one side of a hexagon
        let line: CGPoint
        let curve: CGPoint
        let control: CGPoint
    }
    
    static let adjustment: CGFloat = 0.085  //adjustment to tune shape of hexagon
    static let segments = [  //segment values are fractions of a unit square that will be used to create the hexagon
        Segment(
